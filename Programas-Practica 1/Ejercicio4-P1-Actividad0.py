...
print("Localizado en los indices del %s-%s"%(A[1]+1,tam-1))
print("Apellido Paterno:")
print(Nombre[0:A[0]])
print("Localizado en los indices del %s-%s"%(0,A[0]))
print("Apellido Materno:")
print(Nombre[A[0]+1:A[1]])
print("Localizado en los indices del %s-%s"%(A[0]+1,A[1]))
print("Iniciales por apellidos:")
print("%s%s%s"%(Nombre[0],Nombre[A[0]+1],Nombre[A[1]+1]))
print("Localizadas en los indices de %s,%s,%s"%(0,A[0]+1,A[1]+1))
