...
def Triangulo():
    ...
    str(resultado)
    print("El área del triángulo es: ",resultado,"u²")
def Rectangulo():
    print("Ingresa la magnitud de la base\n")
    base=float(input())
    print("Ingresa la magnitud de la altura\n")
    ...
    str(resultado)
    print("El área del rectángulo es: ",resultado,"u²")
def Circulo():
    print("Ingresa la magnitud del radio\n")
    radio=float(input())
    resultado=numpy.pi*(radio*radio)
    str(resultado)
    print("El área del círculo es: ",resultado,"u²")
def error():
    print("Error")
switch={
     1: Triangulo,
