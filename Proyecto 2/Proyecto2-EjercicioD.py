...
class Controladora:
    def main(self):
        ...
        vector=['B','T','H','M','O','C','Z','G','L','E','N','P','R','D','J','Q'
                ,'F','W','X']
       
        for i in vector:
            print("Se insertará ",i)
            BT.InsertarArbolb(actual,ord(i))    
        print()
        print("Imprime raiz")
        ...
        BT.imprimirNodo(BT.raiz.hijos[4])
        print("Imprime hijos 5")
        BT.imprimirNodo(BT.raiz.hijos[5])
