...
class Controladora:
    def main(self):
        ...
        a=Vertice('a')
        g.agregarVertice(a)
        edges=['ah','ab','ag','ba','bc','bk','bi','bj','cb','cd','ck','dc','de','dl','ed','em','ef','fg','fe','fn','gf','gn','gh','ga','hi','hg','ha','hn','ih','io','ij','ib','in','ji','jb','jk','jo','jm','kc','kj','kl','lk','ld','lm','ml','mp','mj','mn','me','nh','nm','np','ni','oi','oj','op','pn','pm','po']
        Alfabeto=[]
